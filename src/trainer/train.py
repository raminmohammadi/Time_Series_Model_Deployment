...
# Configure logging
gs_log_file_path = 'gs://timeseries-end-to-end/logging/log_file.log'
...
bucket_name = 'timeseries-end-to-end'
...
def store_data_in_gcs(blob_path, data):
    ...
    try:
        ...
        client = storage.Client.from_service_account_json(os.path.join(main_folder,
                                                                       'timeseries-end-to-end-404019-092c4f76be69.json'))
...
def data_transform(df):
    ...
    try:
        ...
        try:
            ...
            bucket = client.get_bucket("timeseries-end-to-end")
            blob = bucket.blob(blob_path)
...
if __name__ == '__main__':
    try:
        ...
        gcs_model_path = f"gs://timeseries-end-to-end/models/"
