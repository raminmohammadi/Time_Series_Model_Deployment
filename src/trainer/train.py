...
def normalize_data(data, stats):
    ...
    for column in data.columns:
        ...
        normalized_data[column] = [(value - mean) / std for value in
                                   data[column]]
...
def data_transform(df):
    ...
    y_train_scaled = (y_train - stats["mean"]['CO(GT)']) / stats["std"][
        'CO(GT)']
...
def main():
    ...
    gcs_train_data_path = "gs://timeseries-mlops/data/train/train_data.csv"
